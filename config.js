...
global.wm = '                「 kanna BOT あ⁩ 」' //Main Watermark

global.wm2 = '꒷︶꒷꒥꒷ ‧ ꒰ฅ˘ Created By - Afgan  ID˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'

global.wm3 = 'kanna BOT'

global.botdate = `⫹⫺ Date/Tanggal :  ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}`

global.bottime = `T I M E / W A K T U : ${moment.tz('Asia/Jakarta').format('HH:mm:ss')}`

global.titlebot = `⫹⫺ Time Sever : ${moment.tz('Asia/Jakarta').format('HH:mm:ss')}\n⫹⫺ Date Server :  ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}
`

global.author = '                「 kanna BOT あ⁩ 」'
...
global.sgc = 'https://chat.whatsapp.com/DVfawsZozt36QdYmfQlsbD'
